package com.example.drawerandbottomnavigation
...
import com.example.drawerandbottomnavigation.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    private fun openFragment(fragement: Fragment){
        val fragmentTransaction: FragmentTransaction = fragmentManager.beginTransaction()
        fragmentTransaction.replace(R.id.fragment_container, fragement)
